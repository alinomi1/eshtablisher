...
const FormationGuidance = () => {
    ...
    const features = [
        { id: '01', text: t('company_formation.cards.01.title') },
        { id: '02', text: t('company_formation.cards.02.title') },
        { id: '03', text: t('company_formation.cards.03.title') },
        { id: '04', text: t('company_formation.cards.04.title') },
        { id: '05', text: t('company_formation.cards.05.title') },
        { id: '06', text: t('company_formation.cards.06.title') },
    ];
    return (
        <>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-10 lg:gap-12 items-center">
                        ...
                        <div data-aos="fade-up">
                            <p className="pb-8 sm:pb-9 lg:pb-10 font-[350] text-sm sm:text-base leading-6 sm:leading-7 text-black">
                                {t.rich("company_formation.description", {
